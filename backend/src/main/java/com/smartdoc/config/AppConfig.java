...
public class AppConfig {
    ...
    @Bean OpenAiChatCompletionsAdapter openAiChatCompletionsAdapter(RestTemplate providerRestTemplate,ObjectMapper json,ProviderUrlPolicy urls){return new OpenAiChatCompletionsAdapter(providerRestTemplate,json,2*1024*1024,urls);}
