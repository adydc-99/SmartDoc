...
|------|-----|--------------|
| Primary | `#173F34` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#2F6F5A` | `--color-secondary` |
| Accent/CTA | `#3F8C70` | `--color-accent` |
| Background | `#F5F7F6` | `--color-background` |
| Foreground | `#17231F` | `--color-foreground` |
| Muted | `#EAF0ED` | `--color-muted` |
| Border | `#DDE5E1` | `--color-border` |
| Destructive | `#C24141` | `--color-destructive` |
| Ring | `#3F8C70` | `--color-ring` |

**Color Notes:** Approved professional forest-green reading workspace. Do not reintroduce the generated purple palette.
